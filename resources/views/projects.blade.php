        ...
        <div class="group border border-border-color-13 shadow-box-shadow-4">
          ...
          <div class="px-5 pt-30px lg:px-30px">
            ...
            <h4 class="text-lg md:text-xl lg:text-22px font-semibold text-heading-color mb-15px">
              <a href="{{ route('project.show', $project->slug) }}" class="hover:text-secondary-color leading-1.3">
                {{ $project->title }}
              </a>
            </h4>
            <div class="text-sm">
              <a href="{{ route('project.show', $project->slug) }}" class="hover:text-secondary-color">
                <i class="flaticon-pin text-secondary-color mr-0.5"></i> {{ $project->address }}
              </a>
            </div>
            ...
            <div class="card-quick-area flex gap-x-2 pb-30px leading-1 transition-all duration-300">
              <ul class="flex gap-x-2">
                <li>
                  <button data-modal-index="1"
                          class="modal-open w-9 h-9 flex items-center justify-center bg-section-bg-1 hover:bg-secondary-color hover:text-white font-bold">
                ...
                <li>
                  <a href="{{ route('project.show', $project->slug) }}"
                     class="w-9 h-9 flex items-center justify-center bg-section-bg-1 hover:bg-secondary-color hover:text-white font-bold">
